    ...
    $.fn.validateInputOnBlur = function(language, config, attachKeyupEvent, eventContext) {
        ...
        if(validation === true) {
            ...
            if(config.borderColorOnError !== '') {
                ...
                //$element.css('background-color', config.borderColorOnError);
            }
        ...
        if (!$.formUtils.haltValidation && errorInputs.length > 0) {
            ...
            $.each(errorInputs, function(i, $input) {
                if (config.borderColorOnError !== '') {
                    ...
                    //$input.css('background-color', config.borderColorOnError);
                }
                $input
                    .addClass(config.errorElementClass)
                    .parent()
    ...
    $.formUtils = {
        ...
        */
        LANG : {
            ...
            requiredFields : 'Please give proper value',
            ...
            badCustomVal : 'You gave an incorrect value',
