...
imp1=Implication.create!(name: 'Analytical Thinking - L3')
imp2=Implication.create!(name: 'Problem Solving - L3')
imp3=Implication.create!(name: 'Team work - L3')
imp4=Implication.create!(name: 'Customer Focus - L1')
imp5=Implication.create!(name: 'Communication skills - L2')
imp6=Implication.create!(name: 'Ability to Prioritise and Organise - L2')
imp7=Implication.create!(name: 'Object Oriented Programming concepts - L2')
imp8=Implication.create!(name: 'MVC - L2')
imp9=Implication.create!(name: 'Database Design - L2')
imp10=Implication.create!(name: 'Design Pattern - L2')
imp11=Implication.create!(name: 'Software Methodologies (Agile, Test Driven Software Development, Iterative Model) - L2')
imp12=Implication.create!(name: 'Review (FindBug, FireBug, Sonar PMD) - L2')
imp13=Implication.create!(name: 'Configuration Management - L2')
imp14=Implication.create!(name: 'Knowledge of iOS (iPhone) - L1')
imp15=Implication.create!(name: 'Android SDK - L1')
imp16=Implication.create!(name: 'J2ME - L1')
imp17=Implication.create!(name: 'J2ME Polish - L1')
imp18=Implication.create!(name: 'Blackberry programming - L1')
imp19=Implication.create!(name: 'HTML / CSS / Javascript - L3')
imp20=Implication.create!(name: 'Knowledge of Databases - L3')
imp21=Implication.create!(name: 'DB/App Architecture Design skills - L2')
imp22=Implication.create!(name: 'Knowledge of IIS Server - L2')
